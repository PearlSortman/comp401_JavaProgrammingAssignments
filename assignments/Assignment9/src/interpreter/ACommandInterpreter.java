...
//				"Unknown", x, y));
	...
	public void interpretCommand() {
		...
		if(compactArray[0] instanceof ACommandToken) {
			...
			if(compactArray[0] instanceof Say && compactArray[1] instanceof QuotedString) {
				turn = true;
				String spokenText = compactArray[1].getOriginalString();
	...
	public AvatarInterface getCurrentAvatar() { return avatar; }
}
